...
{{update|sa4|sa5}}
{{for|Dami|the Stoneward nicknamed 'the Stormwall'|pre='Stormwall' redirects here}}
A **highstorm** (Alethi: [[File: Kecheh.svg|19px]][[File: Modern zeras.svg|22px]], romanization: *Kezeras*){{file ref|Alethi_Glyphs_Page_1.jpg|Alethi Glyphs Page 1}} is a massively [[Investiture|Invested]] hurricane on the planet of [[Roshar]]. Prior to the [[Night of Sorrows]], It occurred once every few days, or at the command of [[Stormfather]], and moved from stormward to leeward (East to West), starting at the [[Origin]].{{book ref|sa1|12}} East of Roshar, the highstorms are incredibly destructive. They progress across the continent, though they weaken gradually as they cross, and are mostly broken by the mountains east of [[Shinovar]].{{book ref|sa1|i|4}}{{book ref|sa5|43}} This weakness is caused by a combination of being over land instead of water, and infusing spheres with [[Stormlight]].{{wob ref|2839}}

## Description
{{image|Highstorm by Noah Bradley.jpg|A stormwall|side=right|width=240px}}
{{for|/Gallery|more images}}
A highstorm has three general stages. The leading edge, or stormwall, is the most dangerous part of the storm. Immensely powerful winds generate a wall of dust, water, and larger debris.{{book ref|sa1|34}} It is shown that it is powerful enough to carry large trees long distances into the [[Shattered Plains]].{{book ref|sa2|69}} The main body of the highstorm carries less debris, although the winds are still strong enough to hurl boulders. The trailing edge of the storm, known as the riddens, consists of light rains mixed with relatively mild gusts of wind.{{book ref|sa1|35}} On average, a highstorm travels at roughly 370 miles per hour,{{wob ref|10231}} and weakens as it moves across the continent; the [[Purelake]], for example, experiences less intense highstorms than areas to the east.{{book ref|sa1|i|1}}

[[Honor]] is able to lessen the impact of the storm in certain areas, and would do so frequently to those that prayed to him.{{book ref|sa5|62}} Before Honor arrived at the planet, the storm itself would sometimes lessen if pled to, and seems to have been weaker in general.{{rpg ref|slwg|106}}
...
[[Stormwarden]]s try to predict when highstorms occur,{{book ref|sa1|44}} and have become somewhat accurate, though not always.{{book ref|sa1|18}} The Stormwardens have poor reputations since predicting the future is forbidden under [[Vorin]] doctrine.
...
Another effect of a highstorm is the [[crem]] in the storm water. This substance is deposited onto the land, accumulating over the millennia, even prior to the [[Shattering]].{{wob ref|8491}} Crem comes from minerals in the highstorm that harden, and it contains minerals and nutrients that are useful for plant life.{{book ref|sa5|19}} Plants fed highstorm water do better than those given lake or river water, as discovered by farmers and Stormwardens.{{book ref|sa1|11}} By the time the highstorm reaches Shinovar, it no longer contains the minerals that harden into crem.{{book ref|sa5|19}} Many plants have outer coverings infused with highstorm [[crem]], forming protective shells.{{wob ref|169}}
...
During the [[Night of Sorrows]], [[Retribution]] had the Everstorm consume the highstorm, causing a slowness bubble to form around the planet.{{book ref|sa5|145}}

## Cultural Significance
{{image|Eshonai by Casey Fallon.jpg|A [[singer]] transforming in a highstorm|side=right|width=300px}}

People on Roshar live in cities and settlements that are protected from highstorms by natural or manmade structures. [[Kholinar]] has its windblades{{book ref|sa1|60}}—large stone formations that divert the highstorm's force— and [[Sesemalex Dar]] has troughs that prevent the city from flooding.{{book ref|sa1|55}} These structures are often city-wide and become an integral part of the city's culture.
