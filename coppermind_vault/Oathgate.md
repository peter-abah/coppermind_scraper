...
Each Oathgate can be locked from either side.{{book ref|sa3|65}}{{book ref|sa3|96}}
...
Those two spren enable the Oathgate to function properly, and control who can travel, and where.{{book ref|sa3|116}} They can be Enlightened by [[Sja-anat]].{{book ref|sa3|87}} This does not impact their ability to work with spren of the uncorrupted Oathgates.{{book ref|sa3|115}}

In the past, the Oathgates have been capable of transporting people in and out of Shadesmar; however, at some point before their slumbering, the [[Sibling]] forbade the Oathgate spren from performing this service.{{book ref|sa3|116}}{{book ref|sa4|22}} As such, this function of the Oathgate was inaccessible. This being said, the spren corrupted by Sja-anat are not bound by this, and can transport people into Shadesmar, and can bring them back into the Physical Realm.{{book ref|sa3|87}}{{book ref|sa5|39}} Some Oathgate spren have since accepted the authority of the Stormfather in this matter, and once again allow travel to Shadesmar.{{book ref|sa4|22}} This includes some of the spren at Urithiru, though others do not accept that the Stormfather has the authority to release them from the orders of the Sibling.

## Oathgate Locations
### Urithiru
The Oathgate platforms of Urithiru are arranged in a circle on the grand plateau in front of the tower.{{book ref|sa3|24}}{{file ref|Urithiru.jpg|Urithiru top-down view}} Each Oathgate is connected to a location in each of the ten ancient [[Silver Kingdoms]].{{map ref|Oathgates}} The platforms are 10 feet high, with ramps leading up to them.{{book ref|sa3|4}} The small control buildings in the center of each platform have mosaics on the floor showing Dawnchant glyphs.{{book ref|sa3|58}} In each control room, the keyhole is at the center of a ten-pointed star on a metal plate.{{book ref|sa3|58}} At the present, the plateau in front of the Oathgates are used for storing lumber and training soldiers.{{book ref|sa3|24}}{{book ref|sa3|64}}

In the Cognitive Realm, the platforms are connected by ramps and glowing walkways, which also lead to the main pillar.{{book ref|sa5|31}}
...
===Azir===
{{image|A Study of the Oathgate Dome of Azimir.jpg|side=right|width=200px|Azir's Oathgate platform}}
...
### Iri
The [[Iri]]ali Oathgate is located in their capital, [[Rall Elorim]].{{map ref|Oathgates}} As the Iri leadership allied with [[Odium]], the Oathgate is currently under their control.{{book ref|sa3|16}} This Oathgate is located at the heart of Rall Elorim, inside a perfectly circular reservoir that collects water from the [[Stormfalls]]. A stone bridge runs to the reservoir’s center, where a weathered temple honoring the One stands on top of the [[Oathgate]]. This temple is its control building.{{rpg ref|slwg|155}}
...
The origin of the Oathgates is unknown, although they may have been constructed during the [[Silver Kingdoms]] epoch, as they link the capitals of those ancient nations.{{book ref|sa2|60}} The Oathgate spren chose this transformation willingly, and were made from inkspren.{{book ref|sa4|49}}{{book ref|sa5|13}} Approximately fifty years before [[Aharietiam]], the city of Stormseat was destroyed in a clash between [[Honor]] and Odium and its Oathgate was forgotten, although the mechanism remained intact.{{book ref|sa5|120}}{{book ref|sa2|86}}{{book ref|sa2|60}}
...
### Rediscovery
{{image|Shallan activating the Stormseat Oathgate by pekgna.png|[[Shallan Davar]] activating the [[Stormseat]] Oathgate after rediscovering it during the [[Battle of Narak]]|side=right|width=300px}}
...
After the Sibling's reawakening, they convinced the majority of the Oathgate spren to work with the [[Coalition of monarchs]].{{book ref|sa5|7}} Following the [[Night of Sorrows]] and the removal of stormlight from Roshar, the Oathgate spren sensed the end of their era and left the Oathgate platforms, rendering them nonfunctional.{{book ref|sa5|145}}
