...
{{update|yumi}}
The **Returned** are resurrected humans on [[Nalthis]]. [[Vasher]] referred to them as Type One [[BioChroma|BioChromatic]] Entities--Spontaneous Sentient BioChromatic Manifestations in a Deceased Host.{{book ref|wb|46}} But upon further study, he now classifies them as a Type Two Invested entity.{{book ref|sa4|15}} They are a kind of [[Cognitive Shadow]].{{wob ref|4995}}
...
Their divine Breath allows them to reach the Fifth Heightening. Children and animals can sense a Returned's divine Breath, which has an effect on their [[spiritweb]] and in the [[Cognitive Realm]], making them feel comfortable and react positively to the Returned.{{wob ref|3950}}{{wob ref|7365}} A Returned may give this Breath in an act of self-sacrifice to heal one person. The healing ability can cure diseases, heal almost any wound, and regrow lost body parts. The sacrifice does not grant the Fifth Heightening to the receiver.{{book ref|wb|12}} The divine Breath can be used for things other than healing, though no one in-world has figured out how to do it yet.{{wob ref|12013}}
...
## Trivia
* A Returned looks different in the [[Cognitive Realm]] compared to a regular human.{{wob ref|11897}}
