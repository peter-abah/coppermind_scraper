...
|[[Shai]]'s description of the Spiritual Realm{{tes ref|12}}
}}
The **Spiritual Realm** is the realm of existence in the [[cosmere]] that contains the essence or soul of things. In this Realm, the [[Connection|interconnection]] between objects, people, and ideals are made apparent.{{tes ref|12}} It is said to transcend form, thought, being, and self; it is merely a network of Connections between the truest form of all things.{{msh ref|3|3}}{{rpg ref|slwg|3}} Within the Spiritual Realm, Investiture takes on its most consistent form,{{wob ref|1647}} and comprises everything within the Realm.{{wob ref|8812}}
...
## Nature
### Shards
The Spiritual Realm, including all of the Connections and souls within it, is made up entirely of Investiture,{{wob ref|8812}} and all of the Investiture which makes it up is part of the body of one of the sixteen Shards.{{wob ref|8605}} Thus, the Spiritual Realm is made up from and one with the Shards.
...
The Spiritual Realm is not a place.{{msh ref|3|3}}{{wob ref|11708}} The Spiritual Realm is made up entirely of [[Investiture]] in the form of [[spiritweb]]s and the [[Connection]]s between them.{{msh ref|3|3}}{{wob ref|8812}}{{wob ref|9280}} As such, time and space are "irrelevant" or "compounded into one" in the Spiritual Realm.{{msh ref|3|3}}{{book ref|sa3|119}}{{book ref|sa3|93}}{{wob ref|6129}}{{wob ref|14822}} This timelessness means that the Spiritual Realm breaks causality, but in a controlled way.{{wob ref|9286}} [[Design]] remarked that time dilation was easier in the Spiritual Realm because time "flows like water into whatever container you provide".{{book ref|yumi|32}}

Because time is irrelevant, an object's Connection to its past as well as its future can be observed from the Spiritual Realm.{{wob ref|6129}} Some beings, like [[Atium#Allomantic_Use|Seers]], [[Moelach]], [[Sak|Sak the Aviar]], and [[Shard]]s can peer into the Spiritual Realm to gain insight into the future, though some methods are more likely to be successful than others and even some Shards have difficulty seeing the future.{{book ref|sa1|75}}{{wob ref|1729}} It is also possible to see into the past of others via similar means.{{msh ref|1|1}} Connection is said by some to connect to even time and reality itself.{{book ref|sa4|66}}

Space being compounded means that, unlike the Physical and the Cognitive Realms, the Spiritual Realm has no distinct locations.{{au ref|sel}}{{wob ref|4843}} As a result, "all things are one" in the Spiritual Realm{{book ref|sa3|93}}{{wob ref|1551}} and those with access to the Spiritual Realm, like Shards, can see what is happening on other worlds and can move around the cosmere more easily.{{wob ref|730}}{{wob ref|1551}}

==== Possibilities ====
The Spiritual Realm contains a vision of every possible world.{{msh ref|3|3}}{{msh ref|1|1}}{{book ref|mb4|part=ars}} This includes possible worlds which are defined by how the world *could have* been if something else occurred in the past, as opposed to merely worlds that can possibly arise from the current actual world.{{book ref|mb4|part=ars}}{{wob ref|7057}}

Possible worlds are not actual worlds, that is to say, that these possible worlds do not exist as alternate universes, but as abstract possibilities.{{wob ref|9280}}{{wob ref|11215}}
...
|[[Hoid]]'s warning to [[Shallan]]{{book ref|sa3|68}}
}}
Future sight always draws upon the Spiritual Realm to work.{{wob ref|8147}} Any time someone sees the future, it will have ripples against someone else's ability to do the same.{{wob ref|11882}} Future sight can be used to gain knowledge of where and when the user needs to be somewhere, and what they need to do.{{wob ref|10011}}{{wob ref|2567}}{{wob ref|738}} This ability is not perfect, and can sometimes tell a user where they are supposed to be without the why.{{wob ref|2567}} Future sight can also alert a user to the presence of certain objects.{{wob ref|2753}} In general, it's been said to be a highly dangerous ability.{{wob ref|8904}}

[[Shard]]s can perceive the future, although it can be difficult for them. Some are better at it than others, with [[Cultivation]] and [[Preservation]] in particular being noted as particularly excelling.{{book ref|sa1|75}}{{wob ref|5309}} Shardic power can also be utilized by others to perceive the future like they do: examples of this are [[atium]], as well as the visions of the [[Returned]].{{wob ref|4645}}

### Allomancy
{{image|Atium Shadow by Danrossidraws.jpg|side=right|width=350px|[[Vin]] surrounded by [[atium]] shadows}}
...
As a result of a [[Mistspren]] being corrupted by [[Sja-anat]], [[Truthwatchers]] have some ability to see visions of the future; these visions seem to appear similar to stained-glass images. This ability is imperfect, as the events it predicts can fail to occur.{{book ref|sa3|118}}{{wob ref|8461}}

;Regal Forms of Power:
By staying out in the [[Everstorm]], [[singer]]s are capable of bonding with a [[voidspren]], changing their form, which alters their physical appearance and mental capabilities.{{book ref|sa3|i|6}}{{wob ref|9897}} One [[Regal]] form of power is nightform, which allows the user to predict the future.{{epigraph ref|sa2|23}}

;Moelach:
[[Moelach]] is the source of the [[Death Rattle]]s, visions of the future experienced by some people on [[Roshar]] during the final moments of their lives.{{book ref|sa2|i|14}}{{epigraph ref|sa3|103}} Those experiencing the visions will often speak aloud in their final moments to communicate what they are seeing in the form of cryptic utterances.{{epigraph ref|sa2|82}}{{book ref|sa1|71}}

### Other Methods
{{image|AU Sixth of the Dusk.jpeg|side=right|width=230px|[[Sak]] showing [[Sixth of the Dusk (character)|Sixth of the Dusk]] visions of his death}}
...
;Returned:
Occasionally, when a person dies, [[Endowment]] grants them a glimpse into the Spiritual Realm, letting them see a possible future. She then offers a chance to [[Returned|Return]] and change the events of the vision.{{wob ref|5943}}{{wob ref|9589}}{{wob ref|143}}

;Wulfden:
[[Wulfden the Fourth]] uses some form of magical foresight.{{wob ref|2226}} The source and extent of his powers are unknown, though it appears to be related to [[Dominion]].{{wob ref|4682}} The mechanics of his ability are unknown, but parallel to similar skills in the cosmere.{{wob ref|4645}}

;Aviar:
One type of [[Aviar]], a raven, allows a person it's bonded with to see visions showing their possible deaths in near future (roughly a minute).{{book ref|iote|15}} These visions manifest in the form of an image of the individual's corpse in the area where a death could happen. The Aviar has control over when they share this ability, and with whom, and can see every vision it shares.{{book ref|iote|12}}

;Hoid:
[[Hoid]] has access to an ability that allows him to make use of the Spiritual attribute of [[Fortune]],{{wob ref|2567}}, which grants him a limited amount of foresight. Hoid's Fortune ability lets him know where and when he needs to be.{{wob ref|10011}} While this ability may grant him knowledge of what he is to do,{{wob ref|2567}}{{wob ref|738}} usually Hoid does not know why his ability has brought him to a specific place.{{wob ref|2567}} Hoid's Fortune ability is not infallible; occasionally it directs him to go somewhere, but either nothing notable is happening or he is unable to discover the reason why he has been led there.{{wob ref|5821}}

;Oathgates:
[[Oathgates]] are capable of sending one or multiple people through the Spiritual Realm in order to quickly bring them between one place and another, without having to obey relativistic laws.{{wob ref|9307}}{{wob ref|16252}}
...
===Spirit Shores===
{{for|Dragon (cosmere)|Dragon}}
{{image|Iote spirit shores.jpg|side=right|width=200px|[[Hoid]] and [[Starling]] walking along the Spirit Shores.}}
The Spirit Shores is a region of the Spiritual Realm where [[Dragon (cosmere)|dragon]]s commune.{{book ref|iote|42}} It appears as the shoreline of a vast ancestral ocean reminiscent of those on [[Yolen]].{{book ref|iote|49}} Dragons who have died reside there waiting for their Investiture to dissipate before moving into the [[Beyond]]. Living dragons and others such as [[Hoid]] can access the region through meditation or dreams to speak with each other or those that have died.{{book ref|iote|42}}{{book ref|iote|51}}

The manacles placed on exiled dragons makes it extremely difficult to access the Spirit Shores.{{book ref|iote|42}}{{book ref|iote|49}}

### Potential Other Inhabitants
Very few beings exist solely in the Spiritual Realm. It is possible for physical beings to travel to the Spiritual Realm, but the results are weird.{{wob ref|13522}} [[Elend Venture]], burning both atium and duralumin, managed to travel mostly to the Spiritual Realm.{{wob ref|6304}} While there, Elend saw “a mind-numbing wealth of information,” including Leras’s plan for Ati’s death.{{book ref|mb3|81}} Flaring one of the temporal metals at the moment of one’s death can also provide a glimpse of the Spiritual Realm.{{msh ref|1|1}} Shards can also give people a glimpse of the Spiritual Realm, generally via eye contact with the Vessel; Leras shows Kelsier the Connection between everything and the possible futures{{msh ref|3|3}} and Odium shows Dalinar the complete nature of his Shard.{{book ref|sa3|57}} Visions, such as the ones Honor left for potential Bondsmiths, almost always involved being pulled partially into the Spiritual Realm, with an additional "Cognitive framework" that allows people to understand them.{{wob ref|9562}} Traveling to the Spiritual Realm can be extremely dangerous for people, as it has the potential to break their brain.{{wob ref|2693}}

There are factions of some kind in the Spiritual Realm,{{wob ref|7000}} as well as native inhabitants.{{wob ref|7001}}

## Culture
### Roshar
Well before the year 1173, the [[Roshar]]an scholar [[Gavarah]] proposed the existence of the three Realms.{{book ref|sa1|29}} That theory seems to be well accepted among modern Rosharan scholars, who are aware that the Spiritual Realm is a place of pure truth but that the Cognitive Realm is more flexible.{{book ref|sa2|24}} The [[spren]] are also aware of the three realms and know that the Shards live in the Spiritual Realm.{{book ref|sa3|93}} At least two religions on Roshar include the Spiritual Realm in their doctrine. [[Vorinism]] equates the Spiritual Realm with the [[Tranquiline Halls]]{{book ref|sa1|16}}{{book ref|sa1|i|8}} and the [[One]] teaches that the Spiritual Realm is the same as the [[Beyond]].{{wob ref|1729}}

### Scadrial
[[Scadrial]] at large first became aware of the three realms when [[Sazed]] mentioned their existence in the [[Words of Founding]].{{epigraph ref|mb3|57}} As of {{date|342|PC}}, the people of the [[Elendel Basin]] have just begun learning about the properties of the Spiritual Realm, mostly by investigating the [[Feruchemy|Feruchemical]] metals that can store Spiritual properties.{{book ref|mb6|3}} The [[kandra]], [[Terris]], and [[Set]] are the primary groups involved in this research and have all done their best to keep it quiet.{{book ref|mb6|3}}{{book ref|mb6|part=ars}}{{book ref|mb6|17}} The Basin's newly-founded relationship with the [[Southern Scadrian]]s, however, may soon make knowledge of the Spiritual Realm more widespread in the Basin.{{book ref|mb6|31}}
...
### Sel
The [[MaiPon]] learned about the Spiritual Realm in order to understand how [[Forgery]] works and are aware that it contains a thing's Identity and Connection, though they may not use those words.{{tes ref|12}}

## Trivia
*The Spiritual Realm is heavily based on the Realm of Forms from Plato's [[wikipedia:Theory of forms|Theory of forms]], which is a realm where perfect Ideals exist, which physical objects merely engage within or imitate.{{cite}}
*Originally, the [[shadowblaze]]s from *[[The Rithmatist]]* were creatures from the Spiritual Realm.{{wob ref|1619}}
