...
<gallery widths=3000px heights=300px mode="packed" caption="Interior art">
Scadrial map.png | <center><small>by {{a|Isaac Stewart}}</small></center> *a map of [[Scadrial]]*

<gallery widths=3000px heights=300px mode="packed" caption="Interior art">
Elendel Map (The Lost Metal).jpeg | <center><small>by {{a|Isaac Stewart}}</small></center> *a map of [[Elendel]]*

<gallery widths=3000px heights=300px mode="packed" caption="Interior art">
The Two Seasons broadsheet.jpg | <center><small>by {{a|Ben McSweeney}}</small></center> *[[The Two Seasons]]*
</gallery>
...
* "A Good Man" by Victor Adame Minguez
* "More Dodgin' and Hitting'" by Jesse Ochse
* "Land Safely, Mate" by Felicia Chen
