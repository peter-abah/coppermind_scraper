{{magic
|related=[[Hion]], [[Hijo]]
|type={{tag|Awakening|text=Awakened}} device
|world=Komashi
|universe=[[Cosmere]]
...
The **father machine**, or simply the **machine** is an [[Awakening|Awakened]] device created by the scholars of the [[Institute of Mechanical Solutions]] in [[Torio City]] on [[Komashi]]. The machine was created to summon [[hijo]] by stacking stones and to use their [[Investiture]] to produce and distribute [[hion]]. The activation of the machine created the [[shroud]] and turned most of the inhabitants of [[Torio]] into [[nightmare]]s.{{book ref|yumi|23}}{{book ref|yumi|39}}

A **machine prototype** is used by the scholars who later investigate [[Yumi]] in [[Gongsha Town]].{{book ref|yumi|40}}
...
The father machine was given instructions to harvest Investiture from spirits (although this includes souls), to be used as a power source, and to protect itself. The machine's abilities derive from this command and it was [[Awakening|Awakened]] using something other than [[Nalthian]] [[Breath]], but the exact method is unknown.{{wob ref|16178}} The Investiture drawn from the hijo is used to create and power hion lines. The machine grows these hion line stubs up from the ground in the surrounding countryside.{{book ref|yumi|40}}

When threatened, the machine can increase the rate at which it works to stack rock, though it becomes more reckless in doing so.{{book ref|yumi|34}} In order to protect itself, the machine uses Investiture to create a transparent barrier around its vicinity which people cannot pass through.{{book ref|yumi|40}} It is also able to repair itself, creating physical parts out of a smokey Investiture drawn from the spirits.{{book ref|yumi|40}} By the time the machine was destroyed, most of the machine had long been replaced in this manner.{{book ref|yumi|41}} The machine is also able to exert influence over the [[nightmare]]s, and uses these as additional tools to defend itself.{{book ref|yumi|40}} Since it was activated, the father machine's level of Investiture endowed it with some level of sentience.{{book ref|yumi|40}}

The machine is able to draw souls from a great distance, apparently due to each human on the planet having some of [[Virtuosity]]'s Investiture within them.{{wob ref|16178}}
