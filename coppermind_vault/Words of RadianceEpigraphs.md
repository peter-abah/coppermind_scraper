...
==Navani's Journal==
In Part One of *[[Words of Radiance]]* the epigraphs are excerpts from the [[Navani's journal|**journal**]] of [[Navani Kholin]]. 
...
## The Diagram
In Part Five of *[[Words of Radiance]]* the epigraphs are all excerpts from the [[Diagram (literature)|Diagram]], a guide to engineering the survival of humanity through the [[True Desolation]] created by [[Taravangian]] on a day of super-human intelligence.
...
|A code. Decrypts to: "Hold the secret that broke the Knights Radiant.  You may need it to destroy the new orders when they return."{{17s ref|post|110242|Decryption method|date=2014-03-12}}
|-
