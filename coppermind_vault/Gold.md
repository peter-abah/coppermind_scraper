{{metal
|allomancy=Show burner's past or alternate self
|type-a=Internal, Pulling, Temporal
|misting=Augur
...
**Gold** is the internal temporal pulling metal. An [[Allomancer]] burning gold is able to see who they could have been in the past, had they made different choices. [[Feruchemist]]s can use gold to store health. When used as a [[Hemalurgic]] spike, gold steals Hybrid Feruchemical powers.

The paired alloy of gold used in the Metallic Arts is [[electrum]].

## Allomantic Use
A gold [[Misting]] is known as a **Augur**. An Augur burning gold is able to see a vision of who the user could have been, known as a "gold shadow."{{book ref|mb4|part=ars}} While active, an Augur can see through both pairs of eyes and think both sets of thoughts.{{book ref|mb4|15}} Due to the emotional stress associated with seeing one's alternate past, gold is not a very useful metal. Furthermore, touching the gold shadow while burning gold causes unpleasant side effects.{{book ref|mb1|37}} Each time an Augur burns gold, they see a different image, as it changes depending on their current situation.{{wob ref|9996}} A gold shadow will also change if a person is stamped with an [[Essence Mark]].{{wob ref|2559}}
...
Gold healing works by aligning an individual's Physical aspect to their ideal self as recorded in their Spiritual aspect. This does not prevent them from aging or certain genetic diseases as those are considered part of the ideal.{{wob ref|3885}}

Foreign objects inside a wound, such as bullets, shrapnel fragments, or other kinds of projectiles, will not be ejected from the skin and will more often be sealed inside the body as the skin and outer muscles regenerate.{{book ref|mb2|58}} This can result in blood poisoning or infection. This would probably work differently if part of the object, such as the shaft of an arrow, is still outside the skin. [[Aluminum]] projectiles or particles in a wound will make it impossible for the Bloodmaker to heal the injury around the metal for as long as it remains in the body.{{wob ref|6365}}

Gold healing would interact with organ transplants in an interesting way. This can be either beneficial or detrimental depending on the circumstances.{{wob ref|11887}} Bloodmakers' bones are particularly interesting due to the time they spend weak and sick, which creates distinctive oddities in the joints and bones.{{book ref|mb6|4}}
...
### Savantism
If someone were to Compound gold enough to become a Feruchemical [[savant]] with the metal, they would be able to survive even longer than a normal Compounder of the metal.{{wob ref|13393}}
...
### Bind Points
* Feruchemical Gold: Feruchemical gold can be stolen by placing a gold spike between two ribs.{{book ref|mb3|5}}
...
## Trivia
*If a gold Feruchemist got a tattoo, it would not stay very easily when they try to heal, but it could stay if their Identity was strong enough.{{wob ref|9675}}
