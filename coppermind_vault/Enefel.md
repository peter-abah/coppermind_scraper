---
source_file: Enefel.txt
entity_type: culture
related: '[[Elantris (city)|Elantris]]'
world: Sel
universe: '[[Cosmere]]'
books: '[[Elantris (book)|Elantris]]'
---

**Enefel** is an [[Aonic]] term for a trickster or joker, as well as a group of the same name. The term is derived from [[Aon#Ene|Aon Ene]], meaning "wit", or "cleverness." Literally, Enefel means "Wit Killers," or "those who kill with wit." The term was most commonly used a few hundred years before the [[Reod]], and isn't in common use by the time of the restoration of [[Elantris (city)|Elantris]]. 
