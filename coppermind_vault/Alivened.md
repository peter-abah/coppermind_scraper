{{lifeform
|image=Alcatraz1 Interior Art ch15.jpg
|type=[[Oculator|Oculatory]] construct
|earth=Alcatraz
|books=[[Alcatraz Versus the Evil Librarians (series)|Alcatraz Versus the Evil Librarians]]
}}
An **Alivened** is a type of [[Wikipedia: Golem|Golem]] created by [[Dark Oculator]]s.{{book ref|a4|2}} They have glass parts which are keys to their being functional.{{book ref|a1|15}} The most powerful ones are referred to as Codexians and are made of paper. They guarded the library that held the [[Sands of Rashid]].
...
==Creation==
Alivened are created by Dark Oculators who give up some of their humanity and invest (note that this book is non-cosmere and has nothing to do with [[Investiture]]) it in [[Glass of Alivening]], which is then put into the object to be Alivened. This removes some of the good human qualities from the Dark Oculator, but the Alivened object does not retain these good qualities -- they are twisted and evil instead.{{book ref|a1|15}}The power of the Alivened is determined by how emotionally dense the material it is made out of is for example, Codexians are made out of bad romance novels because they can soak up emotion, making them especially powerful.{{book ref|a1|14}}
