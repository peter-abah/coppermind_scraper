...
|[[Siri]]'s first impression of T'Telir{{book ref|wb|4}}
}}
**T'Telir** is the capital city of [[Hallandren]] on [[Nalthis]].{{book ref|wb|prologue}} It is set on the coast and is known for its blaze of color because of the dyes grown in the area. A person from T'Telir is called a T'Telirite.{{book ref|wb|25}}
...
## Landmarks
{{image|The_Prophecy_of_the_Fallen_City_by_AutomaticMoon.jpg|side=left|height=280px|[[Lightsong]] dreams of T'Telir.}}
### The City Walls
...
## Notable Residents
{{for|:Category:Residents of T'Telir|a full list see}}
{{columns|
* [[Susebron]]
* [[Siri]]
* [[Bluefingers]]
