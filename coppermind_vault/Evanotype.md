...
Evanotypes are captured using special cameras. Early evanotype cameras were large and required the subject to stand still. The camera used by the [[kandra]] explorer [[ReLuur]] was a newer model that could take action pictures and was small enough to fit in ReLuur's pack.{{book ref|mb6|3}} Even later, by {{date|348|PC}}, Scadrians had figured out how to make moving images.{{book ref|mb7|45}} It is not clear when evanotypes were invented, but by around {{date|330|PC}} they were relatively common, as people living in the [[Roughs]] had access to them.{{book ref|mb5|5}} A few years before {{date|348|PC}}, the city of [[Bilming]] saw the rise of **evanoplays**. It is unknown what these are exactly, but [[Jak]] invested in them.{{file ref|The_Two_Seasons_broadsheet.jpg|*The Two Seasons* broadsheet}}
...
[[Harmony]] let slip to the kandra the concept of moving images, although he refused to expand on the subject.{{book ref|mb6|3}} Moving evanoscope images were later discovered by an organisation known as the [[Set]].{{book ref|mb7|45}}
