...
! colspan=4 class=title |Base Metals
|-
! width=10% | Metal
! width=30% | [[Allomancy|Allomantic ability]]
! width=30% | [[Feruchemy|Feruchemical ability]]
! width=30% | [[Hemalurgy|Hemalurgic ability]]
|-
{{/row|Iron      | Pulls on nearby sources of metal                   | Stores physical weight   | Steals strength }}
{{/row|Steel     | Pushes on nearby sources of metal                  | Stores physical speed    | Steals physical Allomancy }}
{{/row|Tin       | Increases senses                                   | Stores senses            | Steals senses }}
{{/row|Pewter    | Increases physical abilities                       | Stores physical strength | Steals physical Feruchemy }}
...
{{/row|Copper    | Hides Allomantic pulses                            | Stores memories          | Steals mental fortitude, memory, and intelligence }}
...
{{/row|Nicrosil  | Enhances Allomantic burn of target                 | Stores [[Investiture]]   | Steals Investiture }}
{{/row|Aluminum  | Wipes internal Allomantic reserves                 | Stores [[Identity]]      | Removes all powers }}
{{/row|Duralumin | Quickly burns any burning metals in powerful burst | Stores [[Connection]]    | Steals Connection and Identity }}
|}
...
! width=30% | [[Hemalurgy|Hemalurgic ability]]
|-
{{/row|Atium    | See into other people's futures | Stores youth{{book ref|mb7|part=ars}} | Steals any power or attribute (must be refined); does so better than any other spike{{wob ref|5971}}}}
...
|}
{| width=100% class=infobox
! colspan=4 class=title |Atium alloys
|-
! width=10% | Metal
! width=30% | [[Allomancy|Allomantic ability]]
! width=30% | [[Feruchemy|Feruchemical ability]]
...
### Harmonium
After contact with the [[Southern Scadrian]]s, a new metal is revealed. Called "[[Ettmetal]]" in their native tongue, the Southern Peoples use it to power their technology. Harmonium burns "with a pure whiteness"{{book ref|mb6|22}} when used in Southern Scadrian machinery, and explodes when it is exposed to water (similar to the [[Wikipedia: Alkali metal|alkali metals]]) making it dangerous if not impossible to ingest for Allomantic purposes. Unlike alkali metal reactions, this reaction does not yield a "Harmonium oxide," but it will yield "something else relevant to the [[cosmere]]." Harmonium's atomic structure is that of a single element.{{wob ref|1663}} When heated by electricity and slowly drawn apart, a nugget of harmonium begins to separate, with the two parts beginning to take on the traits of atium and lerasium. However, when the string of metal between them is cut, both sides return to being mere harmonium.{{book ref|mb7|15}}

### Trellium
Also known as [[Trellium|Bavadinium]]. It is a silvery metal with a red cast to it, and dark red spots similar to rust.{{book ref|mb5|21}}{{book ref|mb5|epilogue}} Its Allomantic and Feruchemical properties are unknown. It can be used Hemalurgically to steal some, if not all, Allomantic and/or Feruchemical abilities and grant them to [[kandra]].{{book ref|mb5|epilogue}} It can also be used on humans to create Hemalurgic constructs.{{book ref|mb5|21}}{{wob ref|6261}} Kandra and Hemalurgic constructs with a single spike of trellium will be hidden from Harmony.{{wob ref|6300}}
<!--Please note this page is for the Scadrian magic system and associated metals -- information about the God Metals of other Shards (eg. Shardblades/Plate and the Dor) should go on their individual pages and/or the God Metal page-->
