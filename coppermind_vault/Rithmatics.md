...
It is mentioned that there was a movement on some of the Isles to open smaller schools on every Isle. The Rithmatic academies felt that this would lead to disunity and widely varied teaching styles, which would be detrimental to unity in [[Tower of Nebrask|Nebrask]].{{book ref|Rithmatist|17}}
...
### Rithmatic Students
Rithmatic students wear grey sweaters.  Boys wear white slacks and girls wear white skirts.{{book ref|Rithmatist|1}} Kneepads are often worn for they need to kneel and draw chalks.{{book ref|Rithmatist|25}}
...
{{anchor|Blad Defense}}
; Blad Defense: A defense that uses Lines of Warding "non-traditionally"{{book ref|Rithmatist|4}} by combining four ellipsoid segments.  The configuration is strong enough that some believe it should be banned from official competitions such as duels and the [[Melee]].{{book ref|Rithmatist|5}}
{{anchor|Keblin Defense}}
; Keblin Defense: A defense that is weak against the Easton Defense in most cases.{{book ref|Rithmatist|1}}
{{anchor|Miyabi Defense}}
; Miyabi Defense: A defense with a "convoluted history".{{book ref|Rithmatist|4}}
...
{{file ref|name=eskridge|Eskridge Defense.svg|Eskridge Defense Illustration}}
{{file ref|name=matson|Matson Defense Diagram.svg|Matson Defense Illustration}}
{{file ref|name=9pt|Nine-Point Circle_Diagram.svg|Nine-point Circle Illustration}}
{{file ref|name=eastonbasic|Basic Easton Defense.svg|Basic Easton Defense Illustration}}
{{file ref|name=eastonadvanced|Advanced Easton Defense.svg|Advanced Easton Defense Illustration}}
{{file ref|name=shoaff|Shoaff Defense.svg|Shoaff Defense Illustration}}
{{file ref|name=taylor|Taylor Defense.svg|Taylor Defense Illustration}}
{{file ref|name=osborn|Osborn Defense.svg|Osborn Defense Illustration}}
{{file ref|name=jordan|Jordan Defense Diagram.svg|Jordan Defense Illustration}}
</references>
{{complete|[[User:Chaos2651|Chaos2651]] ([[User talk:Chaos2651|talk]]) 18:13, 10 November 2017 (MST)}}
{{Rithmatist}}
[[Category: Magic]]
[[Category: Rithmatics| ]]